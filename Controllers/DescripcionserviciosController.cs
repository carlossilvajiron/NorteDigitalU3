...
namespace prueba.Controllers
{
    ...
    public class DescripcionserviciosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(uint id, [Bind("Id,Nombre,ServicioId")] Descripcionservicio descripcionservicio)
        {
        ...
        private bool DescripcionservicioExists(uint id)
        {
